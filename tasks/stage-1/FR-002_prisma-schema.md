...
- **Blocks (직접 12건):** FR-003(접근 계층) · FR-004(원장 기입) · FR-005(게이트 G2) · FR-007(판정 함수) · FR-008(도메인 계약) · FR-009(Mock) · FR-010 · FR-015 · FR-020 · FR-024 · FR-027 · FR-030
...
`FR-001 → FR-002 → FR-003 → FR-006 → FR-008 → FR-012 → FR-025 → FR-027 → FR-028 → FR-029` (10단계)이며, 여기서 밀린 만큼 **종점(회고 화면)이 그대로 밀린다.**
