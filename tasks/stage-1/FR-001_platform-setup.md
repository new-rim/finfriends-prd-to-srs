...
**Scenario 2: 리전 일치 (AC-T13.1 — §8 배분은 FR-045 · 여기서는 1차 확인)**
- **Given:** 배포가 완료된 상태
...
- [ ] AC-T13.1 **1차 확인** — 배포 후 함수·DB 리전이 일치하는가? *(정식 판정은 FR-045 배포 환경 감사)*
...
- **Blocks (직접 16건):** FR-002(스키마) · FR-005(게이트) · FR-006(Action 골격) · FR-010(인증) · FR-013 · FR-019 · FR-023 · FR-024 · FR-029 · FR-030 · FR-035 · FR-038 · FR-039 · FR-040 · FR-042 · FR-045
